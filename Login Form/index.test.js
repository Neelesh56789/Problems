...
//   test('Clicking "Forget password?" link', async (done) => {
//     // Create a mock function for window.alert
//     const mockAlert = jest.fn();
//     window.alert = mockAlert;
...
//     inputName.value = "Neelesh";
//     input_email.value = "neelesh@codingninjas.com";
//     input_pass.value = "neelesh@123";
...
//       expect(input_email_1).toBe("");
//       expect(input_pass_1).toBe("");
//       expect(inputName_1).not.toBe(inputName.value);
//       expect(input_email_1).not.toBe(input_email.value);
//       expect(input_pass_1).not.toBe(input_pass.value);

//       // Test that the mockAlert function was called with the expected message
//       expect(mockAlert).toHaveBeenCalledWith('Verification Code has been sent to your mail');
